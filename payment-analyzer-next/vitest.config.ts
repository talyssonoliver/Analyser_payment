...
const SUPABASE_ANON_KEY =
  ...
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS10ZXN0IiwicmVmIjoidGVzdCIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNjQwOTk1MjAwfQ.test_key_for_testing";
    ...
    projects: [
      ...
      },
      {
        test: {
          ...
          exclude: ["node_modules", "dist", ".next", "out", "**/*.server.test.ts"],
          coverage: {
            provider: "v8",
            reporter: ["text", "json-summary"],
            // Write into subdir to avoid rmdir on mountpoint volume

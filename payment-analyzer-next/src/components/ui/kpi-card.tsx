    ...
    >
      ...
      <div className="relative flex items-start justify-between gap-4">
        <div className="space-y-2">
          <div className={cn("text-xs font-semibold uppercase tracking-wide", toneStyle.label)}>
            {label}
          </div>
      ...
      {children ? (
        <div className="relative mt-4 space-y-2 text-xs text-slate-500">{children}</div>
      ) : null}
    </div>
  );
}

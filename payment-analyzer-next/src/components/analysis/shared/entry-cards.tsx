                ...
                <div className="entry-breakdown mt-4 pt-3 border-t border-slate-200 group-hover:border-slate-300 transition-colors duration-300">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                    <div className="breakdown-item bg-slate-50 rounded-lg p-2 group-hover:bg-white group-hover:shadow-sm transition-all duration-300">
                      <span className="breakdown-label text-slate-600 block text-xs uppercase tracking-wide font-semibold">
                        Consignments
                      </span>
                      <span className="breakdown-value font-bold text-slate-900 text-sm block mt-1">
                        {entry.consignments}
                      </span>
                    </div>
                    <div className="breakdown-item bg-slate-50 rounded-lg p-2 group-hover:bg-white group-hover:shadow-sm transition-all duration-300">
                    ...
                    {entry.earlyArrive && entry.earlyArrive > 0 && (
                      <div className="breakdown-item bg-green-50 rounded-lg p-2 group-hover:bg-green-100 group-hover:shadow-sm transition-all duration-300 border border-green-200">
                        <span className="breakdown-label text-green-600 block text-xs uppercase tracking-wide font-semibold">
                          Early Bonus
                        </span>
                        <span className="breakdown-value font-bold text-green-700 text-sm block mt-1">
                          {formatCurrency(entry.earlyArrive)}
                        </span>
                      </div>
                    )}
                    {entry.attendanceBonus && entry.attendanceBonus > 0 && (
                      <div className="breakdown-item bg-green-50 rounded-lg p-2 group-hover:bg-green-100 group-hover:shadow-sm transition-all duration-300 border border-green-200">
                        ...
                        <span className="breakdown-value font-bold text-green-700 text-sm block mt-1">
                          {formatCurrency(entry.attendanceBonus)}
                        </span>
                      </div>
                    )}
                    {entry.unloadingBonus && entry.unloadingBonus > 0 && (
                      <div className="breakdown-item bg-blue-50 rounded-lg p-2 group-hover:bg-blue-100 group-hover:shadow-sm transition-all duration-300 border border-blue-200">
                        <span className="breakdown-label text-blue-600 block text-xs uppercase tracking-wide font-semibold">
                          Unloading
                        </span>
                        <span className="breakdown-value font-bold text-blue-700 text-sm block mt-1">
                          {formatCurrency(entry.unloadingBonus)}
                        </span>
                      </div>
                    )}
                  </div>
      ...
      {entries.length > 3 && (
        <div className="text-center mt-2">
          <p className="text-xs text-slate-500">
            💡 Click any entry to edit • Scroll for more entries
          </p>
        </div>
      )}
    </div>

...
import { Calendar, ChevronDown, ChevronRight, TrendingDown, TrendingUp } from "lucide-react";
...
interface WeeklyBreakdownProps {
  readonly weeklyData: WeekData[];
  readonly className?: string;
  readonly onWeekReportClick?: (weekData: WeekData) => void;
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <button
                      type="button"
                      className="flex items-center justify-center w-6 h-6 rounded-md hover:bg-slate-200 transition-colors"
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500 mt-1">
                        Week {isoWeek}, {isoYear} • {week.workingDays} working days •{" "}
                        {week.totalConsignments} consignments
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="hidden sm:flex items-center gap-4 text-sm">
                      ...
                      <div className="text-center">
                        ...
                        >
                          ...
                          {week.totalDifference >= 0 ? "+" : ""}
                          {formatCurrency(week.totalDifference)}
                        </div>
                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-4 bg-slate-50/50">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      ...
                      <div className="text-center p-3 bg-white rounded-lg border">
                        ...
                        <div
                          className={`text-sm font-semibold ${getDifferenceClass(week.totalDifference)}`}
                        >
                          {week.totalDifference >= 0 ? "+" : ""}
                          {formatCurrency(week.totalDifference)}
                        </div>
                  ...
                  <div className="overflow-x-auto">
                    ...
                    <div className="md:hidden">
                      {week.days.map((day) => (
                        <div key={day.date} className="border-b border-slate-200 p-4 space-y-3">
                          <div className="flex items-center justify-between">
                            <div>
                              <div className="font-medium text-slate-900">
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                            ...
                            <span
                              className={`text-sm font-semibold ${getDifferenceClass(day.difference)}`}
                            >
                              {day.difference >= 0 ? "+" : ""}
                          ...
                          {day.totalBonus > 0 && (
                            <details className="text-xs text-slate-600">
                              ...
                              <div className="mt-2 pl-4 space-y-1">
                                ...
                                {day.pickupTotal > 0 && (
                                  <div>
                                    Pickups: {formatCurrency(day.pickupTotal)} ({day.pickupCount})
                                  </div>
                                )}
                              </div>
                            </details>
                        ...
                        <tbody>
                          {week.days.map((day) => (
                            ...
                            >
                              ...
                              <td
                                className={`py-3 px-4 text-right font-medium ${getDifferenceClass(day.difference)}`}
                              >
                                {day.difference >= 0 ? "+" : ""}
                                {formatCurrency(day.difference)}
                              </td>

...
interface AnalysisSummaryProps {
  readonly data: AnalysisSummaryData;
...
export function AnalysisSummary({
  ...
  const kpiData = data.totals
    ...
    : {
        ...
        baseTotal: data.totalExpected,
        bonusTotal: data.totalExpected,
        pickupTotal: 0,
        averageDaily: data.averageDaily,
        overallStatus:
          data.difference >= 0
      ...
      {(!showDetailedBreakdown || !data.weeks || data.weeks.length === 0) && (
        <div className="legacy-summary">
          ...
          <div className="summary-cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            ...
            {/* Difference */}
            <div
              className={`summary-card ${differenceBgColor} rounded-xl p-6 border border-slate-200 shadow-sm`}
            >
              <div className="flex items-center justify-between mb-2">

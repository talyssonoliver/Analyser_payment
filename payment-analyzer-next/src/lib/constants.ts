...
export const DEFAULT_PAYMENT_RULES = {
  weekdayRate: 2.0, // £2.00 per consignment Monday-Friday
  saturdayRate: 3.0, // £3.00 per consignment Saturday
  unloadingBonus: 30.0, // £30.00 per day (except Mondays)
  attendanceBonus: 25.0, // £25.00 per day (weekdays only)
  earlyBonus: 50.0, // £50.00 per day (weekdays only)
} as const;

      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-slate-600">
            {analysis.period.start.toISOString().split("T")[0]} to{" "}
            {analysis.period.end.toISOString().split("T")[0]} • Created{" "}
              ...
              <div className="ml-4">
                ...
                <div className="flex items-center">
                  <p className="text-2xl font-bold text-slate-900">
                    {analysis.totalConsignments.count}
                  </p>
                </div>
              </div>
            </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <div className="flex items-center">
                  <p
                    className={`text-2xl font-bold ${getDifferenceColor(analysis.differenceTotal.amount)}`}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between py-2">
                ...
                <span
                  className={`font-medium ${getDifferenceColor(analysis.differenceTotal.amount)}`}
                >
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-slate-500">
              Detailed daily breakdown will be displayed here once the analysis entity is fully
              integrated.
            </p>
          </div>
        </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {analysis.metadata.originalFilenames.map((filename, _index) => (
                <div
                  key={`file-${filename}`}

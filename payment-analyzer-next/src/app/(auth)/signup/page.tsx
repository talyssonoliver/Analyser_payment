  ...
  return (
    <>
      <CardHeader className="text-center">
        ...
        <p className="text-sm text-slate-600">Join Payment Analyzer to manage your settlements</p>
      </CardHeader>
        ...
        <div className="space-y-2">
          <label className="flex items-start space-x-2">
            ...
            <span className="text-sm text-slate-600">
              I agree to the{" "}
              <Link prefetch={false} href="/terms" className="text-blue-600 hover:text-blue-500">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link prefetch={false} href="/privacy" className="text-blue-600 hover:text-blue-500">
                Privacy Policy
              </Link>
            </span>
          </label>
